"""
Django settings for link2csl project.
...
SECRET_KEY = 'wskivjb*-4ppl+sgq8$yqqb*s+oj3jjwo7i^iq28sh9@0)#vhm'
...
WSGI_APPLICATION = 'link2csl.wsgi.application'
